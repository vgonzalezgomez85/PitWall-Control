...
const Map<String, List<String>> _textos = {
  ...
  'Altura motor': ['Altura motor', 'Motor height', 'Altezza motore', 'Hauteur moteur'],
  'Anchura eje delantero': ['Anchura eje delantero', 'Front axle width', 'Larghezza asse anteriore', 'Largeur essieu avant'],
  'Anchura eje trasero': ['Anchura eje trasero', 'Rear axle width', 'Larghezza asse posteriore', 'Largeur essieu arrière'],
  'Conforme': ['Conforme', 'Compliant', 'Conforme', 'Conforme'],
  'No conforme': ['No conforme', 'Non-compliant', 'Non conforme', 'Non conforme'],
  'Carrocería': ['Carrocería', 'Bodywork', 'Carrozzeria', 'Carrosserie'],
  'Bien': ['Bien', 'Good', 'Buono', 'Bon'],
  'Faltan piezas': ['Faltan piezas', 'Missing parts', 'Pezzi mancanti', 'Pièces manquantes'],
